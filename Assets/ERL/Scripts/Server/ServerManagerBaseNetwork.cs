...
namespace Assets.CryptoKartz.Scripts.managers
{
    ...
    public abstract class ServerManagerBaseNetwork : M2MqttUnityClientNetwork
    {

        /// <summary>
        /// Network Runner Prefab used to Spawn a new Runner used by the Server
        /// </summary>
        [SerializeField] protected Fusion.NetworkRunner _runnerClientPrefab;
        [SerializeField] protected Fusion.NetworkRunner _runnerServerPrefab;
